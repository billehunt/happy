...
export const SettingsSchema = z.object({
    ...
    quickReplySuggestions: z.boolean().describe('Append tappable answer-suggestion chips (the <options> block) to the end of assistant messages'),
