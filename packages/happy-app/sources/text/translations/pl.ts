...
export const pl: TranslationStructure = {
    ...
    time: {
        ...
        compactMinutes: ({ count }: { count: number }) => `${count} min`,
        compactHours: ({ count }: { count: number }) => `${count} godz`,
        compactDays: ({ count }: { count: number }) => `${count} dni`,
    },
    ...
    session: {
        ...
        renameMessage: 'Pozostaw puste, aby wrócić do automatycznej nazwy.',
        renamePlaceholder: 'Nazwa sesji',
        pinAction: 'Przypnij',
        unpinAction: 'Odepnij',
        archiveAction: 'Zarchiwizuj',
        unarchiveAction: 'Cofnij archiwizację',
        deleteAction: 'Usuń',
        deleteConfirmTitle: 'Usuń sesję',
        deleteConfirmMessage: 'To trwale usunie sesję i jej wiadomości. Tej operacji nie można cofnąć.',
    ...
    sidebar: {
        ...
        searchNoResults: ({ query }: { query: string }) => `Brak sesji pasujących do "${query}"`,
        limitToProjects: 'Ogranicz do projektów',
        allProjects: 'Wszystkie projekty',
        showOnlyProject: 'Pokaż tylko ten projekt',
        newSessionHere: 'Nowa sesja tutaj',
        sortModeProject: 'Pogrupowane wg projektu',
        sortModeRecent: 'Wszystkie wg ostatniej aktywności',
        pinned: 'Przypięte',
