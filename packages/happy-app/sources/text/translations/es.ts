...
export const es: TranslationStructure = {
    ...
    session: {
        ...
        renameMessage: 'Déjalo vacío para volver al nombre automático.',
        renamePlaceholder: 'Nombre de la sesión',
        pinAction: 'Fijar',
        ...
        deleteConfirmMessage: 'Esto elimina permanentemente la sesión y sus mensajes. Esta acción no se puede deshacer.',
    ...
    sidebar: {
        ...
        searchNoResults: ({ query }: { query: string }) => `Ninguna sesión coincide con "${query}"`,
        limitToProjects: 'Limitar a proyectos',
        allProjects: 'Todos los proyectos',
        showOnlyProject: 'Mostrar solo este proyecto',
        newSessionHere: 'Nueva sesión aquí',
        sortModeProject: 'Agrupado por proyecto',
