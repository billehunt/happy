...
export const ca: TranslationStructure = {
    ...
    session: {
        ...
        renameMessage: 'Deixa-ho buit per tornar al nom automàtic.',
        renamePlaceholder: 'Nom de la sessió',
        pinAction: 'Fixa',
        unpinAction: 'Desfixa',
        archiveAction: 'Arxiva',
        unarchiveAction: 'Desarxiva',
        deleteAction: 'Elimina',
        deleteConfirmTitle: 'Elimina la sessió',
        deleteConfirmMessage: 'Això elimina permanentment la sessió i els seus missatges. Aquesta acció no es pot desfer.',
        deleteFailed: 'Error en eliminar la sessió',
    },
    ...
    sidebar: {
        ...
        searchNoResults: ({ query }: { query: string }) => `Cap sessió coincideix amb "${query}"`,
        limitToProjects: 'Limita a projectes',
        allProjects: 'Tots els projectes',
        showOnlyProject: 'Mostra només aquest projecte',
        newSessionHere: 'Nova sessió aquí',
        sortModeProject: 'Agrupades per projecte',
