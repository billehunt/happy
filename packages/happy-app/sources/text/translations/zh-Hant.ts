...
export const zhHant: TranslationStructure = {
    ...
    time: {
        ...
        compactMinutes: ({ count }: { count: number }) => `${count}分鐘`,
        compactHours: ({ count }: { count: number }) => `${count}小時`,
        compactDays: ({ count }: { count: number }) => `${count}天`,
    },
    ...
    session: {
        ...
        renameMessage: '留空以還原為自動名稱。',
        renamePlaceholder: '工作階段名稱',
        pinAction: '釘選',
        unpinAction: '取消釘選',
        archiveAction: '封存',
        unarchiveAction: '取消封存',
        deleteAction: '刪除',
        deleteConfirmTitle: '刪除工作階段',
        deleteConfirmMessage: '此操作將永久刪除工作階段及其訊息，且無法復原。',
    ...
    sidebar: {
        ...
        searchNoResults: ({ query }: { query: string }) => `沒有符合「${query}」的工作階段`,
        limitToProjects: '限制為特定專案',
        allProjects: '所有專案',
        showOnlyProject: '僅顯示此專案',
        newSessionHere: '在此新建工作階段',
        sortModeProject: '依專案分組',
