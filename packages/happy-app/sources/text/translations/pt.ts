...
export const pt: TranslationStructure = {
    ...
    session: {
        ...
        renameMessage: 'Deixe em branco para voltar ao nome automático.',
        renamePlaceholder: 'Nome da sessão',
        pinAction: 'Fixar',
        ...
        deleteConfirmMessage: 'Isso exclui permanentemente a sessão e suas mensagens. Esta ação não pode ser desfeita.',
    ...
    sidebar: {
        ...
        searchNoResults: ({ query }: { query: string }) => `Nenhuma sessão corresponde a "${query}"`,
        limitToProjects: 'Limitar a projetos',
        allProjects: 'Todos os projetos',
        showOnlyProject: 'Mostrar apenas este projeto',
        newSessionHere: 'Nova sessão aqui',
        sortModeProject: 'Agrupadas por projeto',
