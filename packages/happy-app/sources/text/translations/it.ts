...
export const it: TranslationStructure = {
    ...
    time: {
        ...
        compactDays: ({ count }: { count: number }) => `${count}g`,
    },
    ...
    session: {
        ...
        renameMessage: 'Lascia vuoto per tornare al nome automatico.',
        renamePlaceholder: 'Nome sessione',
        pinAction: 'Fissa',
        unpinAction: 'Rimuovi fissaggio',
        archiveAction: 'Archivia',
        unarchiveAction: 'Rimuovi da archivio',
        deleteAction: 'Elimina',
        deleteConfirmTitle: 'Elimina sessione',
        deleteConfirmMessage: 'Questa operazione elimina definitivamente la sessione e i suoi messaggi. Non può essere annullata.',
    ...
    sidebar: {
        ...
        searchNoResults: ({ query }: { query: string }) => `Nessuna sessione corrisponde a "${query}"`,
        limitToProjects: 'Limita ai progetti',
        allProjects: 'Tutti i progetti',
        showOnlyProject: 'Mostra solo questo progetto',
        newSessionHere: 'Nuova sessione qui',
        sortModeProject: 'Raggruppate per progetto',
        sortModeRecent: 'Tutte per attività recente',
        pinned: 'Fissate',
        archived: 'Archiviate',
        working: 'Al lavoro…',
